			...
			<div ref={ref} className={s.skills}>
				...
				<div className={s.block}>
					...
					<div className={s.box}>
						...
						Начиная с 2019 года  зантересовался wed-разработкой. На данный момент пишу, экспериментирую для себя и других,(сайты-лендинги) как хобби. Большей частью верстаю, но также люблю логику JS, React. В основном работаю по туториалам, много серфю интернет. Также не забываю добавить, что-то от себя). Стараюсь применить свои навыки в профессиональном плане.
					</div>
				</div>
			</div>
